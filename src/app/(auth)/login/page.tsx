      ...
      <div className="w-full max-w-md bg-zinc-900/60 backdrop-blur-xl border border-zinc-800 p-8 rounded-2xl shadow-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-2 text-sm">
            Entre na sua conta para gerenciar seus álbuns
          </p>
        </div>
        ...
        <p className="text-center text-zinc-500 text-xs mt-8">
          Não tem uma conta?{" "}
          <Link href="/cadastro" className="text-violet-400 hover:text-violet-300 font-semibold underline decoration-violet-500/30 underline-offset-4">
